...
public class Options{
    ...
    public static boolean hasOldVersion(final Context aContext){
        File file = new File(Environment.getExternalStorageDirectory().getAbsolutePath() + Files.OPTIONS,
                getOptionsFilename(aContext));
        return file.exists();
    }
    ...
    public static void setLastModified(String aLastModified, final Context aContext){
        PreferenceManager.getDefaultSharedPreferences(aContext).edit().
                putString("options.last-modified", aLastModified).
                apply();
    }

    public static String getLastModified(Context aContext){
        return PreferenceManager.getDefaultSharedPreferences(aContext).getString("options.last-modified", "");
    }

    public static void setConfigRemotePath(String aLastPath, final Context aContext){
        PreferenceManager.getDefaultSharedPreferences(aContext).edit().
                putString("options.last-path", aLastPath).
                apply();
    }

    public static String getConfigRemotePath(Context aContext){
        return PreferenceManager.getDefaultSharedPreferences(aContext).getString("options.last-path", "/");
    }
    ...
    public static String getOptionsFilename(final Context aContext){
        return getDeviceId() + ".properties";
    }
